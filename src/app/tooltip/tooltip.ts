...
export class Tooltip implements OnDestroy {
  ...
  alignRight() {
    ...
    let left =
      hostOffset.left + this.domHandler.getOuterWidth(this.el.nativeElement);
    let top =
      hostOffset.top +
  ...
  alignBottom() {
    ...
    let left =
      ...
      (this.domHandler.getOuterWidth(this.el.nativeElement) -
        ...
        2;
    let top =
      hostOffset.top + this.domHandler.getOuterHeight(this.el.nativeElement);
    this.container.style.left = left + 'px';
    this.container.style.top = top + 'px';
  }
  ...
  destroy() {
    ...
    if (this.container && this.container.parentElement) {
      ...
      else this.domHandler.removeChild(this.container, this.appendTo);
    }
    this.container = null;
  }
